...
public class C01_Arrays {
    public static void main(String[] args) {
        /*
         * Array (Dizi): Java'da birden fazla aynı type variable depolamak (store etmek)
         * icin kullanilan bir objedir.
         * Array tanımlamak için:
         * 1- data type (Bir array'in icerisinde sadece ayni data tipinden variable
         * omalıdır.)
         * 2- length (length array'e depolanacak max eleman sayisini belirtir ve
         * length'den fazla eleman koyulursa RTE verir)
         * 
         * Array'de primitive datalar veya non-primitive datalarin referanslari store
         * edilebilir
         * isimler array'inin icinde isim degerleri degil, isimlerin referanslari
         * saklanır
         */
        ...
        // Trick -> ataması yapılmayan bir array herhangir actiona alınamaz CTRE
        // veririr.
        ...
        sayiArr[1] = 2;// sayiArr 1. idex 2 value update-> array elemanları unique olmak zorunda değil
                       // tekrarlı eleman barındırabilir
        sayiArr[3] = 2;
        sayiArr[4] = 46;
        ...
        // Array eleman print etme...-> Array doğrudan sout komutu ile print edilirse
        // ref. değerei verir
        // Arrays.toString(array); ile sout edilmeli

        System.out.println("isimArr = " + isimArr);// -> array non-primitive data oldg için stacde referans değer print
                                                   // eder :[Ljava.lang.String;@3d8c7aca
        ...
        System.out.println();
        // Task-> isimArray de 5 karakterden fazla olan elemanı print eden code create
        // ediniz
        ...
        // Task-> isimArray de 6 karakterden az olan elemanı saklayan arrayı print eden
        // code create ediniz
        ...
        System.out.println("Arrays.toString(isimArr) = " + Arrays.toString(isimArr));// [Yusuf, Murat, Ceren, *Vedat,
                                                                                     // **Suzan, son eleman bükücü Abdi]
        Arrays.sort(isimArr);// naturel sırlama yapıldı
        System.out.println("Arrays.toString(isimArr) = " + Arrays.toString(isimArr));// [**Suzan, *Vedat, Ceren, Murat,
                                                                                     // Yusuf, son eleman bükücü Abdi]
